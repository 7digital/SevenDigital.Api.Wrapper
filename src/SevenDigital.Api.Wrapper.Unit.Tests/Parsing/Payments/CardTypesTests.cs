...
namespace SevenDigital.Api.Wrapper.Unit.Tests.Parsing.Payments
{
	[TestFixture]
	public class CardTypeTests
	{
		...
		private readonly Response stubResponse = ResponseCreator.FromBody(HttpStatusCode.OK, ResponseBody);
